Function SQLDBSourceCompletion  {
    ...
    (Get-Item 'HKCU:\software\ODBC\ODBC.INI\ODBC Data Sources').property | Where-Object {$_ -notmatch " Files$" -and  $_ -like "$wordToComplete*" } |
            Sort-Object | ForEach-Object {
                $tooltip =  (Get-ItemProperty -name $_ -path 'HKCU:\software\ODBC\ODBC.INI\ODBC Data Sources').$_
